...
# change to ALL_genepy_exonic.meta if working only on exonic variants
grep -E "\W$GENE;?\s" ALL_genepy.meta > "$GENE".tmp1

# header is generated by doing |grep "^Chr" ALL_genepy.meta> header. See README.md
